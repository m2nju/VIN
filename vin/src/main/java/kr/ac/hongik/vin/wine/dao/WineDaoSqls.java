...
public class WineDaoSqls {
	...
	public static final String SELECT_PAGING = "SELECT wine21_code, korean_name, english_name, country, region, winary, grape_variety, vintage, capacity, type FROM wine ORDER BY wine21_code DESC limit :start, :limit";
